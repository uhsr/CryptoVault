...
#[derive(Debug)]
pub struct CryptoVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoVault processing");
    
    let mut processor = CryptoVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoVaultProcessor::new(false);
